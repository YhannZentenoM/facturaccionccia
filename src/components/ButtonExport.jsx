    ...
    let tabla = [
      {
        ...
        G: "pricelist_id/id",
        H: "currency_id/id",
        I: "sunat_transaction_type",
        J: "comment",
        K: "invoice_line_ids/account_id/id",
        L: "invoice_line_ids/product_id/id",
        M: "invoice_line_ids/name",
        N: "invoice_line_ids/quantity",
        O: "invoice_line_ids/uom_id/id",
        P: "invoice_line_ids/price_unit",
        Q: "invoice_line_ids/account_analytic_id/id",
        R: "invoice_line_ids/invoice_line_tax_ids/id",
      },
    ];
    data.forEach((row) => {
        for (let i = 0; i < row.detalle_productos.length; i++) {
            tabla.push({
                ...
                I: i == 0 ? "VENTA INTERNA" : "",
                J: i == 0 ? "CUENTAS BANCARIAS\n\nBANCO DE CREDITO (BCP)\nCUENTA CORRIENTE: 215-00144900-80\nCCI: 002-215-000014490080-20\n\nBANCO CONTINENTAL\nCUENTA CORRIENTE: 0011-0220-0100000403-14\nCCI: 011-220-000100000403-14\n\nBANCO SCOTIABANK PERU SAC\nCUENTA CORRIENTE: 000-3228827\nCCI: 009-310-000003228827-46" : "",
                K: "l10n_pe.1_759910",
                L: row.detalle_productos[i].producto_id_odoo.trim(),
                M: row.detalle_productos[i].descripcion,
                N: row.detalle_productos[i].cantidad,
                O: "product.product_uom_unit",
                P: row.detalle_productos[i].precio_unitario,
                Q: row.detalle_productos[i].centro_costos,
                R:
